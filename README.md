...
You can also pin to a [specific release](https://github.com/step-security/create-pull-request/releases) version in the format `@v8.x.x`
...
| `body` | The body of the pull request. | `Automated changes by [create-pull-request](https://github.com/step-security/create-pull-request) GitHub action` |
...
```yml
    steps:
      ...
      - name: Create commits
        run: |
          git config user.name 'step-security'
          git config user.email 'step-security@users.noreply.github.com'
          date +%s > report.txt
      ...
      - name: Create Pull Request
        ...
        with:
          ...
          body: |
            ...
            [1]: https://github.com/step-security/create-pull-request
          labels: |
            report
            automated pr
          assignees: step-security
          reviewers: step-security
          team-reviewers: |
            developers
            qa-team
          milestone: 1
