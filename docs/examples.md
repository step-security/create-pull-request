      ...
      - name: Create Pull Request
        ...
        with:
          ...
          body: |
            ...
            [2]: https://github.com/step-security/create-pull-request
      ...
      - name: Set output variables
        ...
        run: |
          ...
          pr_body="This PR was auto-generated on $(date +%d-%m-%Y) \
            by [create-pull-request](https://github.com/step-security/create-pull-request)."
...
```
https://github.com/step-security/create-pull-request/pull/1 was created.
```
