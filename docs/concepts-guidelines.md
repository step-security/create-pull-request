...
This action uses [ncc](https://github.com/vercel/ncc) to compile the Node.js code and dependencies into a single JavaScript file under the [dist](https://github.com/step-security/create-pull-request/tree/main/dist) directory.
...
6. The following example workflow shows how to use [step-security/ghaction-import-gpg](https://github.com/step-security/ghaction-import-gpg) to import your GPG key and allow the action to sign commits.
